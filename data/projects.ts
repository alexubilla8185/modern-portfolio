...
const projects: Project[] = [
  {
    ...
    "description": "A reusable React component for showcasing content in an engaging, 3D animated carousel. You're using it right now! It's built with TypeScript and styled with Tailwind CSS, featuring smooth transitions and intuitive navigation. \n\nUsage:\n```jsx\n<ProjectShowcase projects={...} />\n```",
    "live_link": "#",
