        ...
        <AnimatePresence>
            {message && (
                ...
                <motion.div
                    ...
                    role="alert"
                >
                    <div className="flex items-center justify-between p-4 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-lg rounded-lg shadow-xl border border-blue-500/40 dark:border-blue-400/40">
