...
// Data is now directly inside the component to avoid module resolution issues.
const projectsData: Project[] = [
  {
    "id": 1,
    "title": "DemBoyzBBQ",
    "description": "A delicious online destination for BBQ lovers. Explore menus, catering options, and more.",
    "image": "https://image.thum.io/get/width/600/crop/400/https://demboyzbbq.netlify.app/",
  ...
  },
  {
    ...
    "image": "https://image.thum.io/get/width/600/crop/400/https://my-modern-resume.netlify.app/",
...
const ProjectGrid: React.FC = () => {
  // The projects data is now defined locally.
  // We can still keep this check for robustness, though it's less likely to fail.
  ...
  // Since the data is local, we no longer need loading or async error states.
  return (
    <section>
